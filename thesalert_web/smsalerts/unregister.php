...
<body>
  ...
  <div class="media-body">
    ...
    Εισάγετε τον αριθμό σας εδώ για να διαγραφείτε από την υπηρεσία.
  </div>
</div>
    <form role="form"  id="myform" autocomplete="on" method="post" action="delete_mobile.php" enctype="multipart/form-data" style="margin:45px 5px 0px 5px">
 ...
 <div class="input-group  input-group-lg">
  ...
  Συμφωνώ με τους όρους χρήσης και δηλώνω ότι ο παραπάνω αριθμός μου ανήκει.
        ...
        <button type="submit" class="btn btn-embossed btn-danger"><span class="glyphicon glyphicon-remove"></span>Διαγραφή</button>
 </form>
 
<div id="alerta">
  <div id="alert" class="alert <?php if($ex=="4"){echo "alert-success";}else{echo "alert-danger";}?> alert-dismissable">
